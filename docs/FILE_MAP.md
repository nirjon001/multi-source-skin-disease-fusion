...
| `src/train_resumable.py` | THE trainer (any machine) | `.\.venv-home\Scripts\python.exe src\train_resumable.py --config configs\phase2_dermnet.yaml --profile home_rx580_dml --resume auto` |
